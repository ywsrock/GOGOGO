...
export const vocabularies = {
    ja: {
        [Translations.BACK_TO_SIGN_IN]: 'ログオンに戻る',
        ...
        [Translations.SIGN_IN_ACTION]: 'ログオン',
        [Translations.SIGN_IN_HEADER_TEXT]: 'アカウントにログオン',
        [Translations.SIGN_IN_TEXT]: 'ログオン',
        [Translations.SIGN_IN_WITH_AMAZON]: 'Amazonでログオン',
        [Translations.SIGN_IN_WITH_AUTH0]: 'Auth0でログオン',
        [Translations.SIGN_IN_WITH_AWS]: 'AWSでログオン',
        [Translations.SIGN_IN_WITH_FACEBOOK]: 'Facebookでログオン',
        [Translations.SIGN_IN_WITH_GOOGLE]: 'Googleでログオン',
